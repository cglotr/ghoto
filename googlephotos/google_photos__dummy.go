...
func (g *Google_photos__dummy) Create_photo(upload_token string, google_album Google_album, file_name string) (*Google_photo, error) {
	return &Google_photo{
		Id:       "id__" + upload_token,
		Filename: "file_name__" + file_name,
	}, nil
}
